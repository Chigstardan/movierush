...
while True:
	for movies in movie_list:
		...
		if movie_name not in printed:
			...
			print(movie_name)
			requests.get("https://api.telegram.org/bot2072842154:AAGunfJyDXX-lJoUusw5KOtvXnUObRtYAAs/sendMessage?chat_id=1147912549&text={}".format(movie_name))
	...
	for series in series_list:
		...
		if series_name not in printed:
			...
			print(series_name)
			requests.get("https://api.telegram.org/bot2072842154:AAGunfJyDXX-lJoUusw5KOtvXnUObRtYAAs/sendMessage?chat_id=1147912549&text={}".format(series_name))
